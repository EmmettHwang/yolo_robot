...
| `block` | **(현재 작업 브랜치, v6.0~)** gradio 기반 + 인식및반응을 블록코딩으로 발전 |
...
| 버전 | 내용 |
|------|------|
| `6.0.20260615.1941` | **`block` 브랜치 6.0 시작**(gradio 분기) + A단계: 각 동작에 🔁반복(1~10)+❓조건(신뢰도/확률/객체수/낮밤). 인식 시 조건 평가·반복·로그. 행 폭 정리+컬럼 헤더에 반복/조건 표시 |
